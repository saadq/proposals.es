 ...
 *
 * The markdown styles were here mostly authored by @sindresorhus: https://github.com/sindresorhus/github-markdown-css
...
const markdownDarkTheme = css`
  .markdown-body {
    ...
    kbd {
      ...
      border-bottom-color: #636e7b66;
      border-radius: 6px;
      box-shadow: inset 0 -1px #636e7b66;
    }
    h1,
    h2,
    h3,
